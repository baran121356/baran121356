...
#an2 = datetime.datetime(2024,6,24,00,0)
#hours = (now.hour)
#if an > an2 or an == an2:
 ...
 #import webbrowser
#webbrowser.open('')
print(('—'*30)+'\n• Bу • @DEZZEVİPTOOL• @bendezze •\n'+('—'*30))
import webbrowser
webbrowser.open('https://t.me/octpscet')
...
tok = input('• {}BOT{} {}𝐓𝐎𝐊𝐄𝐍 𝐆𝐈𝐑: {}'.format(B,C,V,K))
print("\r")
print(('—'*30)+'\n• 𝐁𝐘 @bendezze • @DEZZEVİP•\n'+('—'*30))
iD = input('• {}BOT{}  {}𝐈𝐃 𝐆𝐈𝐑: {}'.format(B,C,V,K))
os.system('clear')
print(('—'*30)+'\n•Bу • @DEZZE • @octopus•\n'+('—'*30))
def cookie(email):
...
def hunting(email):	
    ...
    'ig_sig_key_version': '4',
		...
		try:
			...
			name = None
		date = date_sc(Id)			
		requests.post(f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/yyyyyy3w/15&caption=*• 𝐳𝐚𝐚𝐟ı 𝐨𝐥𝐚𝐧 𝐬𝐚𝐥𝐭𝐚𝐧𝐚𝐭 𝐤𝐮𝐫𝐚𝐦𝐚𝐳...
• ||𝐦𝐚𝐝𝐞𝐦 𝐤𝐚𝐫𝐭𝐚𝐥𝐬ı𝐧ı𝐳 𝐮𝐜𝐮𝐧 𝐠𝐞𝐥𝐢𝐧 𝐨𝐠𝐥𝐮𝐦.||*
""");hunt = ("""
DEZZEVİPTOOL🫵
★ 𝐀𝐝 : {}
★ 𝐒𝐨𝐲𝐚𝐝 : {}
...
def check_email(email):
	...
	bo = f'\x1b[38;5;{b}m'
	check+=1
	sys.stdout.write(f"\r   {bo}[ {C} 𝐧𝐞𝐱ı𝐨 {bo}] {C}hatalı MA : {F}{good_hot}  {C}Hatalı IG : {R}{bad_ig}  {C}Güzel IG : {X}{good_ig}  {C}{bo}Denetlenen•{check}\r")
	sys.stdout.flush()
